...
public class BooksFragment extends Fragment {
    ...
    private ChangeBooksWebviewUrlListner listner;

    public BooksFragment(ChangeBooksWebviewUrlListner listner) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root_view = inflater.inflate(R.layout.fragment_books, container, false);
        loading = root_view.findViewById(R.id.loadingLayout);

        webView = (WebView) root_view.findViewById(R.id.webView1);
    ...
    public interface ChangeBooksWebviewUrlListner {
