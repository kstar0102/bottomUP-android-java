...
public class ReportsFragment extends Fragment {
    ...
    private ChangeReportsWebviewUrlListner listner;

    public ReportsFragment(ChangeReportsWebviewUrlListner listner) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root_view = inflater.inflate(R.layout.fragment_reports, container, false);
        loading = root_view.findViewById(R.id.loadingLayout);

        webView = (WebView) root_view.findViewById(R.id.webView5);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(final WebView _view, final String _url) {
                if (!_url.equals(Config.SERVER_URL + Config.SCHEDULE_URL)) {
                    if (listner != null) {
                        if (_url.equals(Config.FACEBOOK_URL) ||
                                _url.equals(Config.SERVER_URL) ||
        ...
        webView.loadUrl(Config.SERVER_URL + Config.SCHEDULE_URL);
    ...
    public interface ChangeReportsWebviewUrlListner {
