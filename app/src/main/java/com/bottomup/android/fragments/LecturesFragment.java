...
public class LecturesFragment extends Fragment {
    ...
    private ChangeLecturesWebviewUrlListner listner;

    public LecturesFragment(ChangeLecturesWebviewUrlListner listner) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root_view = inflater.inflate(R.layout.fragment_lectures, container, false);
        loading = root_view.findViewById(R.id.loadingLayout);

        webView = (WebView) root_view.findViewById(R.id.webView3);
        ...
        webView.loadUrl(Config.FACEBOOK_URL);
    ...
    public interface ChangeLecturesWebviewUrlListner {
